...
try:
    ...
    while True:
        ...
        if prev_frame is not None:
            ...
            if pupil_centers:
                # Pintar las pupilas y el centro de la pupila
                for (cX, cY) in pupil_centers:
                    cv2.circle(frame, (cX, cY), 5, (0, 0, 255), 2)  # Rojo para la pupila izquierda
                    cv2.circle(frame, (cX, cY), 5, (255, 0, 0), 2)  # Azul para la pupila derecha
